 ...
 *
 */
class Meigee_MeigeewidgetsFlatshop_Block_Featuredcategory
...
implements Mage_Widget_Block_Interface
{
	...
	public function sliderGridSelection() {
		switch ($this->getData('visible_products')){
			...
			break;
			case '4':
				return 'grid_12 four-products';
			break;
			case '5':
				return 'grid_12 five-products';
			break;
			case '6':
				return 'grid_12 six-products';
			break;
		}
	}
    ...
    public function getSliderOptions () {
        ...
        if ($this->getData('template') == 'meigee/meigeewidgetsflatshop/slider.phtml' and $this->getData('autoSlide') == 1) {
            $options =
            ', autoSlide: 1, '
