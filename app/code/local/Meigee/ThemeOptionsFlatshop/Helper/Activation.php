 ...
 *
 */
class Meigee_ThemeOptionsFlatshop_Helper_Activation extends Mage_Core_Helper_Abstract
{
    protected $settings;
    private $_file = '/app/code/local/Meigee/ThemeOptionsFlatshop/etc/blocks.xml';
