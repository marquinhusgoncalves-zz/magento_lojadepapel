 ...
 *
 */
class Meigee_ThemeOptionsFlatshop_Helper_Menu extends Mage_Core_Helper_Abstract
{
 
	public function getMenuStaticBlocks () {

		$staticList = Mage::getStoreConfig('meigee_flatshop_general/menu/menu_static');
