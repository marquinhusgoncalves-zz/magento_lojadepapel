 ...
 */
class Meigee_ThemeOptionsFlatshop_Block_Html_Topmenu extends Mage_Page_Block_Html_Topmenu
{
    ...
    {
        $menuContent = MAGE::helper('ThemeOptionsFlatshop')->getThemeOptionsFlatshop('menu');
        $html = '';
        ...
        $navigation = MAGE::helper('ThemeOptionsFlatshop')->getThemeOptionsFlatshop('menu');
        ...
        foreach ($children as $child) {
            ...
            if ($child->hasChildren()) {
                ...
                if ($navigation['type'] == 'menu_wide' && $menuContent['additional'] ) {
                    ...
                    if(Mage::helper('ThemeOptionsFlatshop')->isActive('identifier', $child->getId()) && $childLevel == 0) {
